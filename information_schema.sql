...
--
-- Servidor: localhost
-- Temps de generació: 21-06-2019 a les 18:06:19
-- Versió del servidor: 10.1.26-MariaDB-0+deb9u1
-- Versió de PHP: 7.0.33-0+deb9u3
...
--
-- Base de dades: `information_schema`
--

-- --------------------------------------------------------

--
-- Estructura de suport per a vistes `ALL_PLUGINS`
...
--
-- Estructura de suport per a vistes `APPLICABLE_ROLES`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `CHANGED_PAGE_BITMAPS`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `CHARACTER_SETS`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `CLIENT_STATISTICS`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `COLLATIONS`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `COLLATION_CHARACTER_SET_APPLICABILITY`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `COLUMNS`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `COLUMN_PRIVILEGES`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `ENABLED_ROLES`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `ENGINES`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `EVENTS`
-- (Veure a sota per a la visualització actual)
--
CREATE TABLE `EVENTS` (
...
--
-- Estructura de suport per a vistes `FILES`
-- (Veure a sota per a la visualització actual)
--
CREATE TABLE `FILES` (
`FILE_ID` bigint(4)
...
--
-- Estructura de suport per a vistes `GEOMETRY_COLUMNS`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `GLOBAL_STATUS`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `GLOBAL_VARIABLES`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `INDEX_STATISTICS`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `INNODB_BUFFER_PAGE`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `INNODB_BUFFER_PAGE_LRU`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `INNODB_BUFFER_POOL_STATS`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `INNODB_CHANGED_PAGES`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `INNODB_CMP`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `INNODB_CMPMEM`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `INNODB_CMPMEM_RESET`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `INNODB_CMP_PER_INDEX`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `INNODB_CMP_PER_INDEX_RESET`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `INNODB_CMP_RESET`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `INNODB_FT_BEING_DELETED`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `INNODB_FT_CONFIG`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `INNODB_FT_DEFAULT_STOPWORD`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `INNODB_FT_DELETED`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `INNODB_FT_INDEX_CACHE`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `INNODB_FT_INDEX_TABLE`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `INNODB_LOCKS`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `INNODB_LOCK_WAITS`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `INNODB_METRICS`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `INNODB_MUTEXES`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `INNODB_SYS_COLUMNS`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `INNODB_SYS_DATAFILES`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `INNODB_SYS_FIELDS`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `INNODB_SYS_FOREIGN`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `INNODB_SYS_FOREIGN_COLS`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `INNODB_SYS_INDEXES`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `INNODB_SYS_SEMAPHORE_WAITS`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `INNODB_SYS_TABLES`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `INNODB_SYS_TABLESPACES`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `INNODB_SYS_TABLESTATS`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `INNODB_TABLESPACES_ENCRYPTION`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `INNODB_TABLESPACES_SCRUBBING`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `INNODB_TRX`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `KEY_CACHES`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `KEY_COLUMN_USAGE`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `PARAMETERS`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `PARTITIONS`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `PLUGINS`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `PROCESSLIST`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `PROFILING`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `REFERENTIAL_CONSTRAINTS`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `ROUTINES`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `SCHEMATA`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `SCHEMA_PRIVILEGES`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `SESSION_STATUS`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `SESSION_VARIABLES`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `SPATIAL_REF_SYS`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `STATISTICS`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `SYSTEM_VARIABLES`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `TABLES`
-- (Veure a sota per a la visualització actual)
--
CREATE TABLE `TABLES` (
`TABLE_CATALOG` varchar(512)
...
--
-- Estructura de suport per a vistes `TABLESPACES`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `TABLE_CONSTRAINTS`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `TABLE_PRIVILEGES`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `TABLE_STATISTICS`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `TRIGGERS`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `USER_PRIVILEGES`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `USER_STATISTICS`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `VIEWS`
-- (Veure a sota per a la visualització actual)
--
CREATE TABLE `VIEWS` (
`TABLE_CATALOG` varchar(512)
...
--
-- Estructura de suport per a vistes `XTRADB_INTERNAL_HASH_TABLES`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `XTRADB_READ_VIEW`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura de suport per a vistes `XTRADB_RSEG`
-- (Veure a sota per a la visualització actual)
--
...
--
-- Estructura per a vista `ALL_PLUGINS`
--
...
--
-- Estructura per a vista `APPLICABLE_ROLES`
--
...
--
-- Estructura per a vista `CHANGED_PAGE_BITMAPS`
--
...
--
-- Estructura per a vista `CHARACTER_SETS`
--
...
--
-- Estructura per a vista `CLIENT_STATISTICS`
--
...
--
-- Estructura per a vista `COLLATIONS`
--
...
--
-- Estructura per a vista `COLLATION_CHARACTER_SET_APPLICABILITY`
--
...
--
-- Estructura per a vista `COLUMNS`
--
...
--
-- Estructura per a vista `COLUMN_PRIVILEGES`
--
...
--
-- Estructura per a vista `ENABLED_ROLES`
--
...
--
-- Estructura per a vista `ENGINES`
--
...
--
-- Estructura per a vista `GEOMETRY_COLUMNS`
--
...
--
-- Estructura per a vista `GLOBAL_STATUS`
--
...
--
-- Estructura per a vista `GLOBAL_VARIABLES`
--
...
--
-- Estructura per a vista `INDEX_STATISTICS`
--
...
--
-- Estructura per a vista `INNODB_BUFFER_PAGE`
--
...
--
-- Estructura per a vista `INNODB_BUFFER_PAGE_LRU`
--
...
--
-- Estructura per a vista `INNODB_BUFFER_POOL_STATS`
--
...
--
-- Estructura per a vista `INNODB_CHANGED_PAGES`
--
...
--
-- Estructura per a vista `INNODB_CMP`
--
...
--
-- Estructura per a vista `INNODB_CMPMEM`
--
...
--
-- Estructura per a vista `INNODB_CMPMEM_RESET`
--
...
--
-- Estructura per a vista `INNODB_CMP_PER_INDEX`
--
...
--
-- Estructura per a vista `INNODB_CMP_PER_INDEX_RESET`
--
...
--
-- Estructura per a vista `INNODB_CMP_RESET`
--
...
--
-- Estructura per a vista `INNODB_FT_BEING_DELETED`
--
...
--
-- Estructura per a vista `INNODB_FT_CONFIG`
--
...
--
-- Estructura per a vista `INNODB_FT_DEFAULT_STOPWORD`
--
...
--
-- Estructura per a vista `INNODB_FT_DELETED`
--
...
--
-- Estructura per a vista `INNODB_FT_INDEX_CACHE`
--
...
--
-- Estructura per a vista `INNODB_FT_INDEX_TABLE`
--
...
--
-- Estructura per a vista `INNODB_LOCKS`
--
...
--
-- Estructura per a vista `INNODB_LOCK_WAITS`
--
...
--
-- Estructura per a vista `INNODB_METRICS`
--
...
--
-- Estructura per a vista `INNODB_MUTEXES`
--
...
--
-- Estructura per a vista `INNODB_SYS_COLUMNS`
--
...
--
-- Estructura per a vista `INNODB_SYS_DATAFILES`
--
...
--
-- Estructura per a vista `INNODB_SYS_FIELDS`
--
...
--
-- Estructura per a vista `INNODB_SYS_FOREIGN`
--
...
--
-- Estructura per a vista `INNODB_SYS_FOREIGN_COLS`
--
...
--
-- Estructura per a vista `INNODB_SYS_INDEXES`
--
...
--
-- Estructura per a vista `INNODB_SYS_SEMAPHORE_WAITS`
--
...
--
-- Estructura per a vista `INNODB_SYS_TABLES`
--
...
--
-- Estructura per a vista `INNODB_SYS_TABLESPACES`
--
...
--
-- Estructura per a vista `INNODB_SYS_TABLESTATS`
--
...
--
-- Estructura per a vista `INNODB_TABLESPACES_ENCRYPTION`
--
...
--
-- Estructura per a vista `INNODB_TABLESPACES_SCRUBBING`
--
...
--
-- Estructura per a vista `INNODB_TRX`
--
...
--
-- Estructura per a vista `KEY_CACHES`
--
...
--
-- Estructura per a vista `KEY_COLUMN_USAGE`
--
...
--
-- Estructura per a vista `PARAMETERS`
--
...
--
-- Estructura per a vista `PARTITIONS`
--
...
--
-- Estructura per a vista `PLUGINS`
--
...
--
-- Estructura per a vista `PROCESSLIST`
--
...
--
-- Estructura per a vista `PROFILING`
--
...
--
-- Estructura per a vista `REFERENTIAL_CONSTRAINTS`
--
...
--
-- Estructura per a vista `ROUTINES`
--
...
--
-- Estructura per a vista `SCHEMATA`
--
...
--
-- Estructura per a vista `SCHEMA_PRIVILEGES`
--
...
--
-- Estructura per a vista `SESSION_STATUS`
--
...
--
-- Estructura per a vista `SESSION_VARIABLES`
--
...
--
-- Estructura per a vista `SPATIAL_REF_SYS`
--
...
--
-- Estructura per a vista `STATISTICS`
--
...
--
-- Estructura per a vista `SYSTEM_VARIABLES`
--
...
--
-- Estructura per a vista `TABLESPACES`
--
...
--
-- Estructura per a vista `TABLE_CONSTRAINTS`
--
...
--
-- Estructura per a vista `TABLE_PRIVILEGES`
--
...
--
-- Estructura per a vista `TABLE_STATISTICS`
--
...
--
-- Estructura per a vista `TRIGGERS`
--
...
--
-- Estructura per a vista `USER_PRIVILEGES`
--
...
--
-- Estructura per a vista `USER_STATISTICS`
--
...
--
-- Estructura per a vista `XTRADB_INTERNAL_HASH_TABLES`
--
...
--
-- Estructura per a vista `XTRADB_READ_VIEW`
--
...
--
-- Estructura per a vista `XTRADB_RSEG`
--
